...
% check_required_functions: Helper function in the AFOSM-SVR modular workflow.
...
afosm_backend = lower(strtrim(string(get_cfg_or(cfg, "afosm_backend", "classic"))));
if strcmp(afosm_backend, "uqlab")
    required = [required, {'uqlab', 'uq_createInput', 'uq_createModel', 'uq_createAnalysis'}]; %#ok<AGROW>
end
